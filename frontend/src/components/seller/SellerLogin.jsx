    ...
    text-gray-600'>
        ...
        rounded-lg shadow-xl border border-gray-200'>
            ...
            <div className='w-full'>
                ...
                outline-primary' type="email" placeholder='Enter your email' required />
            </div>
            <div className='w-full'>
                <p>Password</p>
                <input onChange={(e) => setPassword(e.target.value)} value={password}  className='border border-gray-200 rounded w-full p-2 mt-1 
                outline-primary' type="password" placeholder='Enter your password' required />
            </div>
