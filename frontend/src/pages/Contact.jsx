...
const Contact = () => {
  return (
    <div>
        <div className="max-w-5xl w-full mx-auto p-10 text-gray-600">
    ...
    <p className="text-left mt-4">
        ...
        <a href="mailto:contact@example.com" className="text-primary hover:underline">support@freshbasket.in</a>
    </p>
    <div className="grid md:grid-cols-3 mt-16">
        <div>
            <svg className="text-primary bg-indigo-500/20 p-2.5 aspect-square rounded-full size-10" width="24"
            ...
            <p className="text-primary mt-1 mb-4">Our team can respond in real time.</p>
            <a href="mailto:support@example.com" className="text-primary font-semibold">
                support@freshbasket.in
            </a>
        </div>
        
        <div>
            <svg className="text-primary bg-indigo-500/20 p-2.5 aspect-square rounded-full size-10" width="21"
            ...
            <p className="text-primary mt-1 mb-4">Available during working hours.</p>
